...
/**
  ...
  @param {ShellySwitchListProps} props
  @param {Array} props.switches The switches of a device.
  @param {Function} props.handleSwitchClick (in Shelly) Will be called when the switch was clicked.
*/
function ShellySwitchList({ switches, handleSwitchClick }: ShellySwitchListProps) {
  ...
  return (
    <Stack direction="row" key={createUUID()}>
      {switches.map((aSwitch: DeviceSwitch) => (
