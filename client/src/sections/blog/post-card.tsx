...
export default function PostCard({
  ...
  const [currentBlogpost, setCurrentBlogpost] = useState<Blogpost>(blogpost);
  ...
  */
  const handleUpdatePost = (formpost: Blogpost) => {
    const updatedPost: Blogpost = { ...currentBlogpost };
    ...
    >
      ...
      {user !== null && user.roleid < 3 && (
        ...
        >
          ...
          {!showReallyDelete && (
            <MenuItem
              data-testid={`blog_delete_button_${index}`}
          ...
          {showReallyDelete && (
            <MenuItem
              data-testid={`blog_reallydelete_button_${index}`}
