...
*/
import type { Params, ParamsSwitch, DeviceConsumption } from '@src/types/device';
...
/**
  ...
  @returns {object} The current status / consumption of all switches as mw/m. Where:
...
*/
export function getDeviceConsumption(deviceName: string, params: Params): DeviceConsumption {
